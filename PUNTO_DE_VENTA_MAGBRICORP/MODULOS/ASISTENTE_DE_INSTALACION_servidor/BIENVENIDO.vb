...
Public Class BIENVENIDO
    ...
    Sub crear_base_normal()
        ...
        Catch ex As Exception
            ...
            Ingresar_instancia_sqlserver.ShowDialog()
    ...
    Sub ejecutar_scryt_crearBase()
        ...
        Try
            ...
            cnn.Open()
            cmd.ExecuteNonQuery()
            textBoxNombreServidor.Text = txtservidor.Text
            SavetoXML(aes.Encrypt("Data Source=" & txtservidor.Text & ";Initial Catalog=BASEADA;Integrated Security=True", appPwdUnique, Integer.Parse("256")))
            ejecutar_scryt_crearProcedimientos_almacenados_y_tablas()
            Timer2.Start()
        Catch ex As Exception
            crear_base_normal()
    ...
    Private Sub Timer3_Tick(sender As Object, e As EventArgs) Handles Timer3.Tick
        ...
        If b > 98 Then
            ...
            lblconfiguracion.Text = "Creando Tablas y precedimientos almacenados... esto puede tardar unos minutos"
