...
"recuperarla, ¿desea continuar?", "Restauración de base de datos", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
    ...
    Private Sub datalistadomateriales_MouseMove(sender As Object, e As MouseEventArgs) Handles datalistadomateriales.MouseMove
        ocultar_objetos_emergentes()
    End Sub

    Private Sub PanelCONTENEDOR_CUENTA_HERRAMIENTAS_Paint(sender As Object, e As PaintEventArgs) Handles PanelCONTENEDOR_CUENTA_HERRAMIENTAS.Paint
