...
Public Class Cierre_de_turno
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        End If
    End Sub
    Sub reemplazo_de_textos_al_html()
        RichTextBox1.Text = RichTextBox1.Text.Replace("@fecha", CIERRE_DE_CAJA.lbldesdehasta.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@usuario_nombre", VENTAS_MENU_PRINCIPAL.lblLogin.Text.ToString)
        RichTextBox1.Text = RichTextBox1.Text.Replace("@ventas_totales", CIERRE_DE_CAJA.LBLTOTALVENTAS.Text.ToString)
        RichTextBox1.Text = RichTextBox1.Text.Replace("@esperado", CIERRE_DE_CAJA.lblDineroEncajaTurnoTOTAL.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@Ganancias", CIERRE_DE_CAJA.lblgananciasVentas.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@fondo_caja", CIERRE_DE_CAJA.lblfondodeCaja.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@ventas_efectivo", CIERRE_DE_CAJA.LBLVENTASenEfectivo.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@cobros", CIERRE_DE_CAJA.lblabonosEfectivo.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@pagos", CIERRE_DE_CAJA.lblPAGOSEfectivo.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@ingresosvarios", CIERRE_DE_CAJA.LBLENTRADASVARIAS.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@gastosvarios", CIERRE_DE_CAJA.lblsalidasvarias.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@vefectivo", CIERRE_DE_CAJA.LBLVentasEnEfectivo2.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@vtarjeta", CIERRE_DE_CAJA.lblventas_Tarjeta.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@vcredito", CIERRE_DE_CAJA.lblVentasAcredito.Text.ToString())
        RichTextBox1.Text = RichTextBox1.Text.Replace("@Tventas", CIERRE_DE_CAJA.lblVentas_suma.Text.ToString())
